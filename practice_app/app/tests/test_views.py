...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.foreign_key_firm = Firm.objects.create(title = 'fk_firm', slug = 'fk_firm', main_inf = 'some inf', photo = 'photo', location = 'location')
        self.foreign_key_firm.place.add(self.many_to_many_place)
        self.foreign_key_firm.productions.add(self.many_to_many_prod)
        self.person_0 = Person.objects.create(name = 'name0', slug = 'name0', main_inf = 'some inf', photo = 'photo', age = 10, gender = 'm', adress = 'adress', nationality = 'nat', family_status = 'status', profession = 'prof', education = 'edu', experience = 'exp', current_place = self.foreign_key_firm, mail = 'mail', phone = 'phone')
    ...
    def test_firmview_GET(self):
        ...
        for firm_num in range(number_of_firms):
            Firm.objects.create(title = 'Firm %s' % firm_num, slug = 'slug %s' % firm_num, main_inf = 'some inf %s' % firm_num, photo = 'photo', location = 'location %s' % firm_num)
    ...
    def test_personview_GET(self):
        ...
        for person_num in range(number_of_people):
            Person.objects.create(name = 'Person %s' % person_num, slug = 'slug %s' % person_num, main_inf = 'some inf', photo = 'photo', age = 10, gender = 'gender', adress = 'adress', nationality = 'nationality', family_status = 'family_status', profession = 'profession', education = 'education', experience = 'experience', current_place = self.foreign_key_firm, telegram = 'telegram', viber = 'viber', skype = 'skype', mail = 'mail', phone = 'phone')
    ...
    def test_create_firm_POST(self):
        ...
        response = self.client.post(url_firm, {
            'title' : 'firm2', 
            'main_inf' : 'some inf', 
            'location' : 'location',  
    ...
    def test_create_person_POST(self):
        ...
        response = self.client.post(url_person, {
            'name' : 'person2', 
            'main_inf' : 'some inf', 
            'age' : 10,
            'gender' : 'm',

...
from app.forms import UserLoginForm, UserRegisterForm, FirmForm, PlaceForm, ProductionForm, PersonForm
from app.models import Place, Production, Firm
...
class TestForms(TestCase):
    ...
    def setUp(self):
        ...
        self.firm1 = Firm.objects.create(title = 'fk_firm', slug = 'fk_firm', main_inf = 'some inf', photo = 'photo', location = 'location')

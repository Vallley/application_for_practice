...
class FirmForm(forms.ModelForm):
    class Meta:
        model = models.Firm
        fields = ['title', 'slug', 'main_inf', 'photo', 'location', 'place', 'productions']
        widgets = {
...
class PersonForm(forms.ModelForm):
    class Meta:
        model = models.Person 
        fields = ['name', 'slug', 'main_inf', 'photo', 'age', 'gender', 'adress', 'nationality', 'family_status', 'profession', 'education', 'experience', 'current_place', 'telegram', 'viber', 'skype', 'mail', 'phone']
        widgets = {
